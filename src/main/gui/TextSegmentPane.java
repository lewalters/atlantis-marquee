...
/**
 * A pane to create or edit a TextSegment
 * <p>
 * <p/> Bugs: None known
 *
...
public class TextSegmentPane extends SegmentPane
{
    ...
    private void construct()
    {
        ...
        subDelayTextField.setTooltip(new Tooltip("The delay between display subsegments of the text segment"));
        ...
        textColorSingle.setTooltip(new Tooltip("Set the text color to a single color"));
        textColorRandom = new RadioButton("Random");
        textColorRandom.setToggleGroup(textGroup);
        textColorRandom.setTooltip(new Tooltip("Set the text colors to be randomly generated by character"));
        textColorCustom = new RadioButton("Custom");
        textColorCustom.setToggleGroup(textGroup);
        textColorCustom.setTooltip(new Tooltip("Set the text color by character"));
        ...
        borderColorNone.setTooltip(new Tooltip("Turn the border off"));
        borderColorRandom = new RadioButton("Random");
        borderColorRandom.setToggleGroup(borderGroup);
        borderColorRandom.setTooltip(new Tooltip("Set the border to randomly generated colors by dot"));
        borderColorCustom = new RadioButton("Custom");
        borderColorCustom.setToggleGroup(borderGroup);
        borderColorCustom.setTooltip(new Tooltip("Set the border to repeating custom colors (up to 4)"));
        ...
        addBorderColorButton.setTooltip(new Tooltip("Add an additional color to the border"));
        ...
        removeBorderColorButton.setTooltip(new Tooltip("Remove the last color from the border"));
        ...
        borderEffectComboBox.setTooltip(new Tooltip("Add a special effect to the border display"));
        ...
        paddingColorNone.setTooltip(new Tooltip("Turn off the padding"));
        paddingColorCustom = new RadioButton("Custom");
        paddingColorCustom.setToggleGroup(paddingGroup);
        paddingColorCustom.setTooltip(new Tooltip("Set the padding to a user-specified color"));
    ...
    protected void populate()
    {
        ...
        else if (borderColors[0].equals(Color.TRANSPARENT))
        {
