...
//        textSegmentButton.setStyle("-fx-border-radius: 15px;");
    ...
    public MenuItem getLoad() { return load;}
    public MenuItem getUndo() { return undo;}
    public MenuItem getRedo() { return redo;}
    public MenuItem getUserGuide() { return userGuide;}
    public MenuItem getAbout() { return about;}
    public Button getStartButton(){return startButton;}
    public CheckBox getAuthenticationCheckBox(){return authenticationCheckBox;}
    public Button getTextSegmentButton(){return textSegmentButton;}
    public Button getImageSegmentButton(){return imageSegmentButton;}
}
